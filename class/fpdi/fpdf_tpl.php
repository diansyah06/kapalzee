...
class FPDF_TPL extends fpdi_bridge
{
    ...
    //kode by batosai untuk bikin sertifikat pdf
...

    {
        if (is_subclass_of($this, 'TCPDF')) {
            $args = func_get_args();
            return call_user_func_array(array($this, 'TCPDF_FONTS::addTTFfont'), $args);
        }
        ...
        parent::addTTFfont($fontfile, $fonttype, $enc, $flags, $outpath, $platid, $encid, $addcbbox, $link);
    }
