...
{?>
	<div class="shopp" onclick="location.href='panel.php?module=viewinbox&id=<?php echo $id ; ?>';" style="cursor:pointer;" >
		...
		<img src="<?php echo $alamat ;?>" width="75" style="float:left" /><div class='tanggal'><?php echo $tanggal .'<img src=' . 'img/inbox/' . $status . '.png  width=10; />'  ; if ($status=='A'){ echo " read " ;}else { echo  " Unread "  ;}  ?></div>
		<div class="label"><?php echo substr($body, 0, 4)   ."(..)       => Click to read more ..." ;?> <p> </p></div>
