...
if ($modulnya=="master" ){$judul= " .:RMS FILE MASTER Explorer:. " ;}else {$judul= " .:RMS FILE Rules Publikasi Explorer:. " ; }

$_CONFIG['main_title'] = $judul;
...
//
$_CONFIG['hidden_dirs'] = array("N_RMS");
...
//
$_CONFIG['upload_allow_type'] = array("pdf","docx","doc","wpd");
...
//
$_CONFIG['upload_reject_extension'] = array("php","html","htm","txt","asp","aspx");
...
class Dir
{
	...
	function Dir($name, $location)
	{
		...
		if ($name=="adms"){die;}//bilaa nemu die
	}
...
?> 
<a href="http://10.0.1.202/">RMS BKI</a>
</div>
<!-- END: Info area -->
</body>
</html>
