...
if ($_GET['module']=='stamp'){

	$gambars = $drawing->get_UploadStampByid($id_gam,$id_kon);
...
{
  $alamat = "../data/temp/temp_"."$user_id"."_$id_kon.pdf";
}

if ($_GET['module']=='readDoc'){
  $alamat= base64_decode($_GET['pathh']);
  $decrypted = fopen($alamat, 'rb');
}else{
