 ...
 */
	...
	/*$from="ibnu_wibowo@klasifikasiindonesia.com";  */                         /* Change this to your address like "me@mydomain.com"; */ 
	...
	$smtp->host_name="mail.klasifikasiindonesia.com"; //IP address       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
	...
	$smtp->pop3_auth_host="mail.klasifikasiindonesia.com";           /* Set to the POP3 authentication host if your SMTP server requires prior POP3 authentication */
	$smtp->user="triyan";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="7890123";                 /* Set to the authetication password */
