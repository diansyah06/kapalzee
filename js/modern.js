...
if (subject != ""){		
	...
	$.post("process.php", {act: act , modul: modul,subject:subject , scheduleTraining:scheduleTraining,idproj:idproj,locationTraining:locationTraining ,descriptionTraining:descriptionTraining } , function(html) {
			$('.mett').html(html);
			$(".mett").hide();
			$(".mett").fadeIn(400);});
...
var start=document.getElementById('start').value;
var due=document.getElementById('due').value;
var tipe=document.getElementById('tipeproject').value;
...
var act ='update' ;
 ...
 $.post("process.php", { projectname: projectname ,idproj:idproj, modul: modul, act:act, target:target,nokontract:nokontract, start:start ,due:due ,tipe:tipe, particpanTraining:particpanTraining,descriptionTraining:descriptionTraining,classno:classno,locationv:locationv,Builder:Builder,Submited:Submited,kontractlink:kontractlink } , function(html) {
			$('.project1').html(html);
			$(".project1").hide();
			$(".project1").fadeIn(400);});
